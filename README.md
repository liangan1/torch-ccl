...
The usage details can be found in the README of corresponding branch. The folloing part is about the usage of ccl_torch1.6. if you want to use other version of torch-ccl please checkout to that branch(tag).
